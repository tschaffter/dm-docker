...
The preprocessing Docker container image contains the following files:
 ...
 - **create_lmdb.sh**: a shell script for creating the training and validation LMDB files (using image data ground-truth labels) that are used to train and validate your Caffe model.
